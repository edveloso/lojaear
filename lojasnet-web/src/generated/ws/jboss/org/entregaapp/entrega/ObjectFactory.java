 ...
 * generated in the ws.jboss.org.entregaapp.entrega package. 
...
public class ObjectFactory {
    ...
    private final static QName _Listar_QNAME = new QName("http://org.jboss.ws/entregaapp/entrega", "listar");
    private final static QName _Salvar_QNAME = new QName("http://org.jboss.ws/entregaapp/entrega", "salvar");
    private final static QName _ListarResponse_QNAME = new QName("http://org.jboss.ws/entregaapp/entrega", "listarResponse");
    private final static QName _SalvarResponse_QNAME = new QName("http://org.jboss.ws/entregaapp/entrega", "salvarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ws.jboss.org.entregaapp.entrega
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.jboss.ws/entregaapp/entrega", name = "listar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.jboss.ws/entregaapp/entrega", name = "salvar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.jboss.ws/entregaapp/entrega", name = "listarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.jboss.ws/entregaapp/entrega", name = "salvarResponse")
